        ...
        <footer className="border-t border-white/5 bg-navy py-12 md:py-8">
            <div className="mx-auto flex max-w-6xl flex-col items-center gap-8 px-6 md:flex-row md:justify-between">
                ...
                <div className="flex items-center gap-4">
                    {/* X (Twitter) */}
                    <a href="https://x.com/gafferscore" target="_blank" rel="noopener noreferrer" aria-label="X" className="flex min-h-[44px] min-w-[44px] items-center justify-center rounded-full text-white/25 transition-colors hover:bg-white/5 hover:text-white/60">
                ...
                <div className="flex items-center text-xs text-white/20">
                    <Link href="/rules" className="flex min-h-[44px] items-center px-4 transition-colors hover:text-white/50">
                        Rules
                    </Link>
                    <Link href="/team" className="flex min-h-[44px] items-center px-4 transition-colors hover:text-white/50">
                        Team
                    </Link>
                    <Link href="/contact" className="flex min-h-[44px] items-center px-4 transition-colors hover:text-white/50">
                        Contact
                    </Link>
