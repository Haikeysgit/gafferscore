                    ...
                    {view !== "forgot" && (
                        <div className="relative mb-5">
                            <input
                                ...
                                required
                                minLength={6}
                                className="w-full rounded-md border-2 border-white/15 bg-white/5 px-4 py-3 pr-12 text-sm text-white placeholder-white/35 outline-none focus:border-mint transition-colors"
                            />
                            <button
                                type="button"
